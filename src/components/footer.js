        ...
        <>
            <section className='LogoAndArabicBtn'>
                ...
                <div className="dropdown">
                    <button className="btn btn-secondary dropdown-toggle lang-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="lang-icon">
                    ...
                    <ul className="dropdown-menu">
                        <li><button className="dropdown-item" type="button" onClick={() => i18n.changeLanguage('ar')}>العربية</button></li>
                        <li><button className="dropdown-item" type="button" onClick={() => i18n.changeLanguage('en')}>English</button></li>
    ...
    return (
        <div className="teach-section">
            <div className="teach-content">
                ...
                <p>{t("Create an online video course, reach students, and earn money")}</p>
            </div>
